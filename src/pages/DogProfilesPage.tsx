...
const mockDogs = [
  {
    ...
    name: "Max",
    breed: "Border Collie",
    birthDate: "2021-06-15", // Changé de age: 3 vers birthDate
    weight: 18, // Changé de "18 kg" vers 18 (number)
    photoURL: undefined,
  ...
  },
  {
    ...
    birthDate: "2022-03-20", // Changé de age: 2 vers birthDate
    weight: 25, // Changé de "25 kg" vers 25 (number)
    photoURL: undefined,
